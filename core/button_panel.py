...
class ButtonPanel:
    """Manages letter buttons with directory bindings"""
    ...
    def __init__(self, screen: pygame.Surface):
        ...
        self.create_buttons()
        logger.info("Button panel initialized with QWERTY layout")
    
    def create_buttons(self):
        """Create letter buttons in QWERTY keyboard layout (3 rows)"""
        qwerty_rows = [
            ['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P'],
            ['A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L'],
            ['Z', 'X', 'C', 'V', 'B', 'N', 'M']
        ...
        logger.info(f"Created {len(self.buttons)} buttons")
